...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BookIt",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC6BookIt11AppDelegate")
...
SWIFT_CLASS("_TtC6BookIt26BookItNavigationController")
@interface BookItNavigationController : UINavigationController
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC6BookIt24BookingListTableViewCell")
...
SWIFT_CLASS("_TtC6BookIt25BookingListViewController")
@interface BookingListViewController : UITableViewController
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC6BookIt22RoomScanViewController")
@interface RoomScanViewController : UIViewController
- (void)viewDidLoad;
- (void)viewWillAppear:(BOOL)animated;
- (void)didReceiveMemoryWarning;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC6BookIt21ScannerViewController")
...
SWIFT_CLASS("_TtC6BookIt15TimeRangeSlider")
@interface TimeRangeSlider : RangeSlider
